...
<div class="btn-toolbar mb-2 mb-md-0">
    <div>
        <a href="{{ route('presences.index', $attendance->id) }}" class="btn btn-sm btn-primary">
        ...
        <div class="row">
            <div class="col-md-6 mb-3 mb-md-0">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="{{ route('presences.permissions', $attendance->id) }}" class="badge text-bg-info text-decoration-none">Karyawaan
                        Izin</a>
                    <a href="{{ route('presences.not-present', $attendance->id) }}" class="badge text-bg-danger text-decoration-none">Belum
                        Absen</a>
                    @if ($attendance->code)
                    <a href="{{ route('presences.qrcode', ['code' => $attendance->code]) }}"
                        class="badge text-bg-success text-decoration-none">QRCode</a>
                    @endif
                </div>
            </div>
