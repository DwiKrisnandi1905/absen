<header class="navbar sticky-top flex-md-nowrap p-0 shadow" style="background-color: #fff;">
    <a class="navbar-brand col-md-11 col-lg-12 me-0 py-2 px-3" href="" style="background-color: #fff;">
        <span><img src="{{ asset('img/Kemenkumham.png') }}" class="mb-2 mx-1 mt-1" style="width: 40px; height: 40px; margin-left: -5px; color: #000;"></span> <h1 style="font-size: 20px; margin-left: 55px; margin-top: -49px; font-weight: bold;">E-Presensi</h1> <p style="margin-left: 55px; margin-top: -10px; margin-bottom: 0px; font-size: 15px; font-weight: bold;">Kumham Jateng</p>
        <span>
            <div id="uploadBox" class=" position-absolute top-0 end-0" style=" margin-top: 5px; border: transparent; padding: 0px; width: 55px; height: 55px; position: relative; overflow: hidden; margin-right: 200px; border-radius: 50%;">
            ...
            <p style="position: absolute; margin-top: -40px; right: 70px; font-weight: bold;">Hallo Admin</p>
        </span>
    </a>
